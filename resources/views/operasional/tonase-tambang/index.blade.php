...
<div class="container">
    ...
    <div class="row justify-content-between mt-3">
        <div class="col-md-6">
            <table class="table">
                <tr class="text-center">
                    ...
                    <td>
                        <form target="_blank" action="{{route('operasional.tonase-tambang.download', $customer)}}" method="get">
        ...
        <div class="col-md-6">
            <form action="{{route('operasional.tonase-tambang', $customer)}}" method="get">
                <div class="row">
