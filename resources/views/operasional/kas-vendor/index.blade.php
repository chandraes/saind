    ...
    <form action="{{route('operasional.kas-vendor')}}" method="get">
        <div class="row">
            ...
            <div class="col-md-3 mb-3">
                ...
                <a href="{{route('operasional.kas-vendor.print', ['bulan' => $bulan, 'tahun' => $tahun, 'vendor' => $vendor])}}" target="_blank"
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center align-middle">
                        ...
                        <a href="{{route('operasional.kas-vendor.detail', ['invoiceBayar' => $d->invoice_bayar_id])}}">{{$d->uraian}}</a>
                        @else
                        {{$d->uraian}}
                        @endif
                    </td>
