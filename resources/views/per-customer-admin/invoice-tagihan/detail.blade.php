        ...
        <div class="col-md-8">
            <table class="table">
                <tr class="text-center">
                    ...
                    <td>
                        <a href="{{route('per-customer-admin.invoice-tagihan')}}"><img src="{{asset('images/invoice-tagihan.svg')}}"
                                alt="dokumen" width="30">
                            Invoice Tagihan
                        </a>
                    </td>
                    <td>
                        <a href="{{route('per-customer-admin.invoice-tagihan.export', ['invoice' => $invoice_id])}}" target="_blank">
