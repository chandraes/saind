<div class="row justify-content-left mt-5">
    <div class="col-md-3 text-center mb-5">
        <a href="{{route('per-customer-admin.nota-tagihan')}}" class="text-decoration-none" >
    ...
    <div class="col-md-3 text-center mb-5">
        <a href="{{route('per-customer-admin.invoice-tagihan')}}" class="text-decoration-none">
    ...
    <div class="col-md-3 text-center mb-5">
        <a href="{{route('per-customer-admin.nota-lunas')}}" class="text-decoration-none">
            <img src="{{asset('images/nota-lunas.svg')}}" alt="" width="70">
            <h5 class="mt-3">REKAP NOTA LUNAS</h5>
        </a>
    </div>
    <div class="col-md-3 text-center mb-5">
        <a href="{{route('per-customer-admin.tonase-tambang')}}" class="text-decoration-none">
