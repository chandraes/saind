        ...
        <table class="table table-hover table-bordered text-pdf">
            <thead class="table-pdf text-pdf table-success">
                <tr class="table-pdf text-pdf">
                    ...
                    <th class="table-pdf text-pdf text-center align-middle">Tgl UJ</th>
                    ...
                    <th class="table-pdf text-pdf text-center align-middle">Tgl Muat</th>
                    @endif
                    ...
                    <th class="table-pdf text-pdf text-center align-middle">Tgl Bongkar</th>
                    @endif
                    ...
                    <th class="table-pdf text-pdf text-center align-middle">Profit</th>
                    <th class="table-pdf text-pdf text-center align-middle">Profit (%)</th>
                    <th class="table-pdf text-pdf text-center align-middle">DO</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($data as $d)
