<div class="container-fluid">
    <form action="{{route('transaksi.nota-tagihan.keranjang', ['customer' => $customer])}}" method="get">
    <div class="row">
        <div class="col-2">
            <div class="mb-3">
        ...
        <div class="col-2">
            <label for="rute_id" class="form-label">&nbsp;</label>
            <div class="d-grid gap-2">
              <a href="{{route('transaksi.nota-tagihan.keranjang', ['customer' => $customer])}}" class="btn btn-secondary">Reset Filter</a>
            </div>
        </div>
    </div>
</div>
