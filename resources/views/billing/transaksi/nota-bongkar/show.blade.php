    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
                ...
                <form action="{{route('transaksi.nota-bongkar.update', $d->id)}}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="tanggal_uang_jalan" id="tanggal_muat"
                                placeholder="" value="{{$d->kas_uang_jalan->tanggal}}" readonly>
                        </div>
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="tambang" id="tambang" placeholder=""
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="nota_muat" id="nota_muat" placeholder=""
                                value="{{$d->nota_muat}}" readonly>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="tonase" class="form-label">Tonase Muat</label>
                            <input type="text" class="form-control" name="tonase" id="tonase" placeholder=""
                                value="{{$d->tonase}}" readonly>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="tonase" class="form-label">Tanggal Muat</label>
                            <input type="text" class="form-control" name="tonase" id="tonase" placeholder=""
                                value="{{$d->id_tanggal_muat}}" readonly>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="nota_bongkar" id="nota_bongkar" placeholder=""
                                value="" required>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="tanggal_bongkar" class="form-label">Tanggal Bongkar</label>
                            <input type="text" class="form-control" name="tanggal_bongkar"
                                id="tanggal_bongkar-{{$d->id}}" placeholder="" required>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="gross_bongkar" id="gross_bongkar-{{$d->id}}"
                                placeholder="" required oninput="calNetto{{$d->id}}()">
                            <small id="helpId" class="form-text text-danger">(Gunakan "." untuk pemisah desimal)</small>
                            <br>
                            <br>
                            <label for="tarra_bongkar" class="form-label">TARRA</label>
                            <input type="text" class="form-control" name="tarra_bongkar" id="tarra_bongkar-{{$d->id}}"
                                placeholder="" required oninput="calNetto{{$d->id}}()">
                            <small id="helpId" class="form-text text-danger">(Gunakan "." untuk pemisah desimal)</small>
                            <br><br>
                            <label for="timbangan_bongkar" class="form-label">Tonase Bongkar</label>
                            <input type="text" class="form-control" name="timbangan_bongkar"
                                id="timbangan_bongkar-{{$d->id}}" placeholder="" value="" required readonly>
                            <small id="helpId" class="form-text text-danger">(Gunakan "." untuk pemisah desimal)</small>
                        </div>
                        @endif
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" form="masukForm{{$d->id}}">Simpan</button>
            </div>
