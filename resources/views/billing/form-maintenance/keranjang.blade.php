            ...
            <div class="modal-body">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center align-middle">{{$b->barang_maintenance->nama}}</td>
                            ...
                            <td class="text-center align-middle">
                                <form action="{{route('billing.form-maintenance.keranjang-destroy', $b->id)}}" method="post">
                                    @csrf
                                    @method('delete')
                ...
                <form action="{{route('billing.form-maintenance.barang-store')}}" method="post" id="beliBarang">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-3">
