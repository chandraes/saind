    ...
    <div style="font-size:12px">
        <table class="table table-bordered table-hover" id="rekapTable">
            ...
            <tbody>
                ...
                @php
                    $gapokPlusTunjanganDir = $dir->gaji_pokok + $dir->tunjangan_jabatan + $dir->tunjangan_keluarga;

                    $bpjs_tk_direksi = $dir->apa_bpjs_tk == 1 ? $gapokPlusTunjanganDir * 0.0489 : 0;
                    $bpjs_k_direksi = $dir->apa_bpjs_kesehatan == 1 ? $gapokPlusTunjanganDir * 0.04 : 0;
                    $potongan_bpjs_tk_direksi = $dir->apa_bpjs_tk == 1 ? $gapokPlusTunjanganDir * 0.02 : 0;
                    $potongan_bpjs_kesehatan_direksi = $dir->apa_bpjs_kesehatan == 1 ? $gapokPlusTunjanganDir * 0.01 : 0;
                ...
                @foreach ($data as $i)
                @php
                    $gapokPlusTunjangan = $i->gaji_pokok + $i->tunjangan_jabatan + $i->tunjangan_keluarga;
                    $bpjs_tk = $i->apa_bpjs_tk == 1 ? $gapokPlusTunjangan * 0.0489 : 0;
                    $potongan_bpjs_tk = $i->apa_bpjs_tk == 1 ? $gapokPlusTunjangan * 0.02 : 0;
                    $bpjs_k = $i->apa_bpjs_kesehatan == 1 ? $gapokPlusTunjangan * 0.04 : 0;
                    $potongan_bpjs_kesehatan = $i->apa_bpjs_kesehatan == 1 ? $gapokPlusTunjangan * 0.01 : 0;
