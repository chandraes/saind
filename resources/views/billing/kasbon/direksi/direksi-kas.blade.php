...
<div class="container">
    ...
    @endif
    <form action="{{route('billing.kasbon.direksi.kasbon-store')}}" method="post" id="masukForm">
        @csrf
        <div class="row">
            <div class="col-4">
                <div class="mb-3">
            ...
            <div class="col-4">
                <div class="mb-3">
                    <label for="direksi_id" class="form-label">Nama Direksi</label>
