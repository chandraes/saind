...
<div class="container">
    <div class="row justify-content-center mb-5">
        <div class="col-md-12 text-center">
            <h1><u>Kas Uang Jalan (Pengembalian)</u></h1>
        </div>
    </div>
    @include('swal')
    @if (session('error'))
    ...
    <form action="{{route('kas-uang-jalan.pengembalian.store')}}" method="post" id="masukForm">
        ...
        <div class="row">
            <div class="col-md-2 mb-3">
                <label for="kode" class="form-label">Saldo Kas Uang Jalan</label>
                <input type="text" class="form-control" name="saldo" value="{{number_format($saldo, 0, ',','.')}}" disabled>
            </div>
            <div class="col-6 mb-3">
                <label for="uraian" class="form-label">Uraian</label>
                <input type="text" class="form-control @if ($errors->has('uraian'))
                    is-invalid
                @endif" name="uraian" id="uraian" required value="Pengembalian Dana" disabled>
            </div>
            <div class="col-md-4 mb-3">
                ...
                <div class="input-group mb-3">
                    ...
                    is-invalid
                @endif" name="nominal_transaksi" id="nominal_transaksi" required data-thousands="." value="{{number_format($saldo, 0, ',','.')}}">
                  </div>
