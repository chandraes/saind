        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @if ($errors->has('singkatan')) is-invalid @endif" name="singkatan" id="singkatan" aria-describedby="helpId"
                        required placeholder="" value="{{$data->singkatan}}">
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @if ($errors->has('npwp')) is-invalid @endif" name="npwp" id="npwp" aria-describedby="helpId"
                        placeholder="" required value="{{$data->npwp}}">
                        @if ($errors->has('npwp'))
                        <div class="invalid-feedback">
                            {{$errors->first('npwp')}}
                        </div>
            ...
            <div class="col-md-12">
                <div class="mb-3">
                    ...
                    <textarea class="form-control @if ($errors->has('alamat')) is-invalid @endif" name="alamat" id="alamat" rows="3">{{$data->alamat}}</textarea>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @if ($errors->has('contact_person')) is-invalid @endif" name="contact_person" id="contact_person" required
                        aria-describedby="helpId" placeholder="" value="{{$data->contact_person}}">
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @if ($errors->has('jabatan')) is-invalid @endif" name="jabatan" id="jabatan" required
                        aria-describedby="helpId" placeholder="" value="{{$data->jabatan}}">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @if ($errors->has('no_hp')) is-invalid @endif" name="no_hp" id="no_hp" required
                        aria-describedby="helpId" placeholder="" value="{{$data->no_hp}}">
                        @if ($errors->has('no_hp'))
                        <div class="invalid-feedback">
                            {{$errors->first('no_hp')}}
                        </div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @if ($errors->has('no_wa')) is-invalid @endif" name="no_wa" id="no_wa" required
                        aria-describedby="helpId" placeholder="" value="{{$data->no_wa}}">
                        @if ($errors->has('no_wa'))
                        <div class="invalid-feedback">
                            {{$errors->first('no_wa')}}
                        </div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control @if ($errors->has('email')) is-invalid @endif" name="email" id="email" required
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control @if ($errors->has('harga_opname')) is-invalid @endif" name="harga_opname" id="harga_opname" required
                            aria-describedby="helpId" placeholder="" value="{{$data->harga_opname}}">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control  @if ($errors->has('harga_titipan')) is-invalid @endif" name="harga_titipan" id="harga_titipan" required
                            aria-describedby="helpId" placeholder="" value="{{$data->harga_titipan}}">
