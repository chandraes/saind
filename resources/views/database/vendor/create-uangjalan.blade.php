...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12 text-center">
            ...
            <h5 class="text-muted">{{ $vendor->nama }}</h5>
        </div>
    </div>
    ...
    <form id="formUangJalan" action="{{ route('uj.vendor.uang-jalan.store') }}" method="post">
        @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="text"
                                                       ...
                                                       name="uang_jalan[]"
                                                       value="{{ number_format($v->uang_jalan ?? 0, 0, ',', '.') }}"
                                                       required
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        // Inisialisasi Cleave.js untuk format angka ribuan
        ...
        // Konfirmasi SweetAlert2 saat submit
        ...
        form.addEventListener('submit', function (e) {
            ...
            Swal.fire({
                ...
                text: 'Apakah Anda yakin ingin menyimpan kesepakatan uang jalan vendor baru ini?',
                icon: 'question',
