        ...
        <div class="row mt-3 mb-3">
            ...
            <div class="row mt-3 mb-3">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control {{$errors->has('no_rekening_uj') ? 'is-invalid' : ''}}" name="no_rekening_uj" id="no_rekening_uj" placeholder="" value="{{old('no_rekening_uj') ? old('no_rekening_uj') : ''}}">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control {{$errors->has('bank_uj') ? 'is-invalid' : ''}}" name="bank_uj" id="bank_uj" placeholder="" value="{{old('bank_uj') ? old('bank_uj') : ''}}">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control {{$errors->has('nama_rekening_uj') ? 'is-invalid' : ''}}" name="nama_rekening_uj" id="nama_rekening_uj" placeholder="" value="{{old('nama_rekening_uj') ? old('nama_rekening_uj') : ''}}">
