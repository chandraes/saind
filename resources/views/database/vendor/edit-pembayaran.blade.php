                            ...
                            <td class="text-center align-middle">
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" name="hk_opname[]"
                                        ...
                                        readonly
                                    @endif value="{{$data->vendor_bayar->where('customer_id', $v->id)->where('rute_id', $i->id)->first() ? $data->vendor_bayar->where('customer_id', $v->id)->where('rute_id', $i->id)->first()->hk_opname : ''}}">
                                </div>
                            </td>
                            <td class="text-center align-middle">
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" name="hk_titipan[]"
                                        ...
                                        readonly
                                    @endif value="{{$data->vendor_bayar->where('customer_id', $v->id)->where('rute_id', $i->id)->first() ? $data->vendor_bayar->where('customer_id', $v->id)->where('rute_id', $i->id)->first()->hk_titipan : ''}}">
                                </div>
                            </td>
                        </tr>
                        @endforeach
