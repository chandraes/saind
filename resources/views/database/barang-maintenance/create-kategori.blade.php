    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <form action="{{route('database.barang-maintenance.kategori.update', $j->id)}}" method="post" id="updateJabatan">
                                    @csrf
                                    @method('patch')
                            ...
                            <td class="text-center align-middle">
                                ...
                                <form action="{{route('database.barang-maintenance.kategori.destroy', $j)}}" method="post" class="d-inline">
                                    @csrf
                                    @method('delete')
                ...
                <form action="{{route('database.barang-maintenance.kategori.store')}}" method="post">
                    @csrf
