                ...
                <tr class="text-center">
                    ...
                    <td>
                        ...
                        <a href="#" data-bs-toggle="modal" data-bs-target="#jabatan">
                            <img src="{{asset('images/jabatan.svg')}}" alt="dokumen" width="30"> Tambah Jabatan
                        </a>

                        <!-- Modal Body -->
                        <!-- if you want to close by clicking outside the modal, delete the last endpoint:data-bs-backdrop and data-bs-keyboard -->
                        <div class="modal fade" id="jabatan" tabindex="-1" data-bs-backdrop="static"
                            data-bs-keyboard="false" role="dialog" aria-labelledby="jabatanTitleId" aria-hidden="true">
                                    ...
                                    <div class="modal-body">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center align-middle">
                                                        <form action="{{route('karyawan.jabatan-update', $j->id)}}"
                                                            method="post" id="updateJabatan">
                                                            @csrf
                                                            @method('patch')
                                                            <input type="text" class="form-control" name="nama_jabatan"
                                                                id="nama_jabatan-{{$j->id}}" aria-describedby="helpId"
                                                                placeholder="" value="{{$j->nama}}" readonly>
                                                    ...
                                                    <td class="text-center align-middle">
                                                        ...
                                                        <a onclick="toggleNamaJabatan({{$j->id}})"
                                                            class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                                        {{-- form delete with confirmation --}}
                                                        <form action="{{route('karyawan.jabatan-destroy', $j->id)}}"
                                        ...
                                        <form action="{{route('karyawan.jabatan-store')}}" method="post">
                                            ...
                                            <div class="input-group mb-3 mt-3">
                                                <input type="text" class="form-control" name="nama_jabatan_tambah"
                                                    id="nama_jabatan_tambah" aria-describedby="helpId"
                    ...
                    <td><a href="{{route('karyawan.create')}}"><img src="{{asset('images/karyawan.svg')}}"
                                alt="add-document" width="30"> Tambah Karyawan</a>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <table class="table table-hover table-bordered" id="karyawan-data">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center align-middle">
                    {{-- show button --}}
                    <a href="{{route('karyawan.show', $k->id)}}" class="btn btn-primary m-2" target="_blank"><i
                            class="fa fa-eye"></i></a>
                    {{-- edit button --}}
