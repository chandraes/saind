        ...
        <div class="col-md-6 ">
            <table class="table">
                <tr class="text-center">
                    ...
                    <td>
                        <form action="{{route('vendor-operational.per-vendor.maintenance-vehicle.print')}}" method="get" target="_blank">
...
<div class="container-fluid table-responsive ml-3">
    <section id="form-input-odo">
        <form action="{{route('vendor-operational.per-vendor.maintenance-vehicle.store-odo')}}" method="post" id="masukForm">
            @csrf
            <input type="hidden" name="vehicle_id" value="{{$vehicle->id}}">
            <div class="row">
                <div class="col-md-2">
