        ...
        <div class="col-md-6">
            <table class="table">
                <tr class="text-center">
                    ...
                    <td><a href="{{route('template-kontrak.create')}}"><img
                                src="{{asset('images/kontrak.svg')}}" alt="add-document" width="30"> Tambah Halaman Kontrak</a>
                    </td>
                    <td>
                        <a href="{{route('kontrak-template.preview')}}" target="_blank"><img
    ...
    <table class="table table-bordered table-hover" id="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center align-middle">{{$d->urutan}}</td>
                <td class="text-center align-middle">
                    <a href="{{route('template-kontrak.edit', $d->id)}}" class="btn btn-warning btn-sm">Edit</a>
                    <form action="{{route('template-kontrak.destroy', $d->id)}}" method="post" class="d-inline">
                        @csrf
                        @method('delete')
