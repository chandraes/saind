...
<div class="container">
    ...
    @include('swal')
    @include('dokumen.sph.create')
    @include('dokumen.sph.kirim-wa')
            ...
            <table class="table">
                <tr class="text-center">
                    ...
                    <td><a href="#" data-bs-toggle="modal" data-bs-target="#modalCreate"><img
                                src="{{asset('images/sph.svg')}}" alt="add-document" width="30"> Tambah
                            SPH</a>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    ...
                    <td class="text-center align-middle">
                        <div class="d-flex justify-content-center flex-wrap gap-3">
                            ...
                            <form action="{{ route('dokumen.sph.destroy', $d) }}" method="post" class="d-inline">
                                @csrf
                                @method('delete')
...
<script>
    function kirimWa(data) {
       ...
       document.getElementById('waForm').action = '/dokumen/sph/kirim-wa/'+data.id;
    }
