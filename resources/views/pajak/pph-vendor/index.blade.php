...
@include('pajak.pph-vendor.faktur-modal')
@include('pajak.pph-vendor.show-faktur')
@include('pajak.pph-vendor.keranjang')
@include('swal')
<div class="container-fluid table-responsive ml-3">
    <div class="row mt-3">
        <form action="{{route('pajak.pph-vendor.keranjang-store')}}" method="post" id="keranjangForm">
            @csrf
            <div class="row">
...
<script>
    ...
    function faktur(id) {
        ...
        form.action = `/pajak/pph-vendor/store-faktur/${id}`;
        form.reset();
