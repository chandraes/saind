    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
                ...
                <table class="table table-bordered table-hover" id="keranjangTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <form
                                    action="{{route('pajak.pph-vendor.keranjang-destroy', ['pphVendor' => $k->id])}}"
                                    method="post">
                                    @csrf
                    ...
                    <tfoot>
                        ...
                        <tr>
                         ...
                         <tr>
                            <th class="text-end align-middle" colspan="4">Uraian</th>
                            <th class="text-end align-middle">
                                <input type="text" class="form-control" name="uraianInput" id="uraianTextInput" required onkeyup="copyUraian()">
                            </th>
                            <th></th>
                        </tr>
                    </tfoot>
            ...
            <div class="modal-footer">
                ...
                <form action="{{route('pajak.pph-vendor.keranjang-lanjut')}}" method="post" id="lanjutForm">
                    @csrf
                    <input type="hidden" name="uraian" id="uraianHidden" value="">
...
<script>
    var nominal = new Cleave('#penyesuaianInput', {
        ...
        function copyUraian() {
            var uraian = document.getElementById('uraianTextInput').value ?? '';
            $('#uraianHidden').val(uraian);
        }
</script>
@endpush
